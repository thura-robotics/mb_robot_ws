...
"""autogenerated by genpy from ired_msgs/MotorControl.msg. Do not edit."""
import codecs
import sys
...
class MotorControl(genpy.Message):
  _md5sum = "05f5241cd8b6cd92a2aaba4f953638ba"
  _type = "ired_msgs/MotorControl"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """float64[4] speed
float64[3] pid_motor_front_left
float64[3] pid_motor_front_right
float64[3] pid_motor_rear_left
float64[3] pid_motor_rear_right"""
  __slots__ = ['speed','pid_motor_front_left','pid_motor_front_right','pid_motor_rear_left','pid_motor_rear_right']
  _slot_types = ['float64[4]','float64[3]','float64[3]','float64[3]','float64[3]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       speed,pid_motor_front_left,pid_motor_front_right,pid_motor_rear_left,pid_motor_rear_right
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_4d().pack(*self.speed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.speed = _get_struct_4d().unpack(str[start:end])
      start = end
      end += 24
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.speed = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=4)
      start = end
      end += 24
