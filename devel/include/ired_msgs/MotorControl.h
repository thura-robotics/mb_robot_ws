// Generated by gencpp from file ired_msgs/MotorControl.msg
// DO NOT EDIT!


#ifndef IRED_MSGS_MESSAGE_MOTORCONTROL_H
#define IRED_MSGS_MESSAGE_MOTORCONTROL_H
...
struct MotorControl_
{
  ...
  typedef boost::shared_ptr< ::ired_msgs::MotorControl_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ired_msgs::MotorControl_<ContainerAllocator> const> ConstPtr;

}; // struct MotorControl_

typedef ::ired_msgs::MotorControl_<std::allocator<void> > MotorControl;

typedef boost::shared_ptr< ::ired_msgs::MotorControl > MotorControlPtr;
typedef boost::shared_ptr< ::ired_msgs::MotorControl const> MotorControlConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ired_msgs::MotorControl_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ired_msgs::MotorControl_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::ired_msgs::MotorControl_<ContainerAllocator1> & lhs, const ::ired_msgs::MotorControl_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::ired_msgs::MotorControl_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ired_msgs::MotorControl_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ired_msgs::MotorControl_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ired_msgs::MotorControl_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ired_msgs::MotorControl_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ired_msgs::MotorControl_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ired_msgs::MotorControl_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ired_msgs::MotorControl_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x05f5241cd8b6cd92ULL;
  static const uint64_t static_value2 = 0xa2aaba4f953638baULL;
};

template<class ContainerAllocator>
struct DataType< ::ired_msgs::MotorControl_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ired_msgs::MotorControl_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ired_msgs::MotorControl_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ired_msgs::MotorControl_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ired_msgs::MotorControl_<ContainerAllocator>& v)
  {
...
#endif // IRED_MSGS_MESSAGE_MOTORCONTROL_H
