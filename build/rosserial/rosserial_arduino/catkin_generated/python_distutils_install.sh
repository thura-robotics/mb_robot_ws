...
echo_and_run cd "/home/thura/mb_robot_ws/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/thura/mb_robot_ws/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/thura/mb_robot_ws/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
